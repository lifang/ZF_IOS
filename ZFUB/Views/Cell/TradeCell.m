...
- (void)setContentWithData:(TradeModel *)tradeModel
    ...
    switch (tradeType) {
        case TradeTypeTransfer:
            _payFromLabel.text = [NSString stringWithFormat:@"付款账号：%@",[self serectString:tradeModel.payFromAccount]];
            _payToLabel.text = [NSString stringWithFormat:@"收款账号：%@",[self serectString:tradeModel.payIntoAccount]];
            break;
...
//            _payFromLabel.text = [NSString stringWithFormat:@"结算时间：%@",tradeModel.payedTime];
        ...
        case TradeTypeRepayment:
            _payFromLabel.text = [NSString stringWithFormat:@"付款账号：%@",[self serectString:tradeModel.payFromAccount]];
            _payToLabel.text = [NSString stringWithFormat:@"转入账号：%@",[self serectString:tradeModel.payIntoAccount]];
            break;
        case TradeTypeLife:
            _payFromLabel.text = [NSString stringWithFormat:@"账  户  名：%@",[self serectNameString:tradeModel.accountName]];
            _payToLabel.text = [NSString stringWithFormat:@"账户号码：%@",[self serectString:tradeModel.accountNumber]];
            break;
        case TradeTypeTelephoneFare:
            _payFromLabel.text = @"";
            _payToLabel.text = [NSString stringWithFormat:@"手机号码：%@",[self serectString:tradeModel.phoneNumber]];
            break;
        default:
            break;
    }
