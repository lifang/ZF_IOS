...
@interface TerminalManagerController ()<UITableViewDataSource,UITableViewDelegate,RefreshDelegate,TerminalManagerDelegate,ProtocolAgreeDelegate>
...
- (void)terminalManagerSynchronizationWithData:(TerminalManagerModel *)model {
    [self synchronizeTerminalWithTerminalID:model.TM_ID];
}
