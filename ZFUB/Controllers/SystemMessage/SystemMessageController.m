...
@interface SystemMessageController ()<UITableViewDataSource,UITableViewDelegate,RefreshDelegate>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell == nil) {
        cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:systemIdentifier];
    }
    MessageModel *model = [_systemMessageItem objectAtIndex:indexPath.row];
    cell.textLabel.text = model.messageTitle;
    cell.detailTextLabel.text = model.messageTime;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MessageModel *model = [_systemMessageItem objectAtIndex:indexPath.row];
    SystemMessageDetailController *detailC = [[SystemMessageDetailController alloc] init];
